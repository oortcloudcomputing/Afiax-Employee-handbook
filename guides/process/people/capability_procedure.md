...
- Step 1: If it is decided a formal performance review must be carried out, Afiax will notify the employee in writing of the reasons why and be invited to a meeting to discuss the problem.
- Step 2: Afiax will then hold the meeting to discuss the problem, allowing the employee to present their case. The employee has the right to bring a companion* with them.
- Step 3: Afiax will then decide on appropriate action to be taken. If it is decided that the employee has been performing unsatisfactorily, the employee will be given a written warning that includes the details of the performance issue, and the timescale in which the issue must be addressed.
...
Where an employee feels that the decision of dismissal is wrong or unjust they should appeal against the decision. Appeals will be heard within a reasonable timeframe in the form of a meeting. Employees should let Afiax know the grounds for their appeal in writing. Employees have the right to be accompanied in their appeal meeting. Afiax will then notify the employee in writing the results of the appeal hearing as soon as possible.

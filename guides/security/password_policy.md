...
- Do not use the same password for access to Afiax systems as for any personal accounts. If you do this, and your Afiax password is compromised, it will open your personal accounts up to vulnerabilities and vice versa.

## 1Password
Afiax uses 1Password as its main password repository. 1Password is administered and maintained by Aura.  There are group vaults which are managed by the teams who use them, but also private vaults where you can store your own information. 

Please use this as your only password management tool for Afiax and client passwords.
...
## Password Security
Cracking passwords or a brute force attack are not the only ways in which individuals with bad intentions can get into the Afiax systems. Social engineering also makes us vulnerable. Attackers will use techniques to gain your trust, or take advantage of inattention or a desire to be helpful to obtain passwords.
...
## 2FA/MFA
Wherever possible Afiax enforces 2FA/MFA or implements SSO.  Please ensure you are enabling 2FA where it is available. 

...
## General Information
With an increasing number of Afiax’s clients requiring security cleared resources to work on their projects, we encourage all client-facing colleagues to consider applying for the appropriate level of security clearance.

The Afiax Compliance Team (compliance@afiax.africa) manages security clearance activities, and will provide helpful information to you before your clearance application is started. Please note that there are minimum residency and work history requirements that need to be met before your application can be commenced. 

All new joiners whose role may need SC at some point are asked whether they already have SC. There is a possibility that existing SC clearance holders may be able to transfer their existing clearance to Afiax, depending upon who issued it and how long it has left to run. For further details, you should contact our Compliance Team. 
...
At the current time, it can take between 8-12 weeks for an application to be assessed and security clearance to be granted. This is outside of Afiax’s control, so an early application into the process is recommended. You will be informed as soon as we become aware of any progression of your application. 

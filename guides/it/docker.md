...
Due to changes within Docker, from Jan 2022 any employees using a Afiax email address must use the Afiax licence for Docker Desktop and not an individual licence.
...
If you have left a project and are still in the team on Docker or you no longer require your licence please ensure you let the ops team know by sending a message to it@afiax.africa

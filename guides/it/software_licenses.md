...
- Kandji - this is a management platform for our Apple devices. Kandji reports back to Aura on security settings, security updates and will allow us to remotely push out settings like the Afiax VPN connection and virus protection
...
If you would like to request new software that Afiax doesn't currently use as standard, or if a client is requesting use of a specific tool, please use [this form](https://docs.google.com/forms/d/14yjYQttTsW38g0gUCTo5gqeUcLd1fFyk8O2pL5PyOr8/edit) to do that. This will go to the Operations Team to review and they'll come back to you directly to clarify anything and talk about set up, onboarding etc.

## Standard Software
If you need access to existing software email [it@afiax.africa](mailto:it@afiax.africa) (except where indicated). This is not an exhaustive list (we're still working on that).

- Google Workspace
- [Slack](https://github.com/oortcloudcomputing/Afiax-Employee-handbook/blob/main/guides/it/slack.md)
- Trello
- [Miro](https://github.com/oortcloudcomputing/Afiax-Employee-handbook/blob/main/guides/it/Miro.md)
...
- Microsoft Azure
- [Docker](https://github.com/oortcloudcomputing/Afiax-Employee-handbook/blob/main/guides/it/docker.md)
- Figma
- Dovetail
- Consent Kit
...
### JetBrains
Licenses for JetBrains software, such as IntelliJ and Rider, can be used with the Afiax license server. Contact IT for access details.
